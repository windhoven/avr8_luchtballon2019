...
# Luchtballon 2019 sourcecode
Atmel Attiny2313

Deze code is gebruikt om Faller luchtballonnen om te bouwen met een brander simulatie: [link naar Youtube video](https://www.youtube.com/watch?v=_r7jHVq7Wew).

De 2019 versie heeft ondersteuning om commando's te ontvangen via de UART. Indien er geen commando's worden ontvangen zal de code werken zoals in de 2012 versie (op willekeurige momenten).
